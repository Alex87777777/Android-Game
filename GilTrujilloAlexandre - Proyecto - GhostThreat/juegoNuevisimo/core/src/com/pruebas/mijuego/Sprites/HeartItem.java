...
public class HeartItem {
    ...
    /**
     * Constructor del Item del corazon
    ...
    public HeartItem(PlayScreen screen, float x, float y) {
        ...
        this.heartTexture = new Texture("textures/heart.png");
    ...
    private void defineItem() {
        ...
        fdef.filter.categoryBits = MiJuego.HEART_ITEM_BIT;
    ...
    public void render(SpriteBatch batch) {
            batch.draw(heartTexture, bounds.getX(), bounds.getY(), bounds.getWidth(), bounds.getHeight());
    }
